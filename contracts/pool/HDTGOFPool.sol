...
contract HDTTokenWrapper {
    ...
    IERC20 public stakeToken = IERC20(0x8D06EB27950b824aFDD3c8b133e2AfDcd4f87a0f); 
...
contract HDTGOFPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen updateReward(msg.sender) checkStart{ 
        require(amount > 0, "HDT-GOF-POOL: Cannot stake 0");
        super.stake(amount);
        emit Staked(msg.sender, amount);
    }

    function withdraw(uint256 amount) public updateReward(msg.sender) checkStart{
        require(amount > 0, "HDT-GOF-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        require(block.timestamp > startTime,"HDT-GOF-POOL: Not start");
        _;
    }

    modifier checkOpen() {
        require(open, "HDT-GOF-POOL: Pool is closed");
        _;
    }
